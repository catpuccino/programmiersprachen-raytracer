...
int main(int argc, char* argv[])
{
 ...
 // SDFToolbox::write_rot_animation(animation_filepath, num_frames, "front", 180.0f, glm::vec3{ 0, 1, 0 });
  //SDFToolbox::write_rot_animation(animation_filepath, num_frames, "boxi", 180.0f, glm::vec3{ 0, 1, 0 });

 // SDFToolbox::write_trans_animation(animation_filepath, num_frames, "front", glm::vec3{ 0, 10, 0 });
